...
<html lang="ms">
    <head>
        ...
        <title><?php echo __('SITE_TITLE') . ' | ' . __('BWDATES_SALES_REPORT'); ?></title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo __('BWDATES_SALES_REPORT'); ?></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php"><?php echo __('DASHBOARD'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo __('BWDATES_SALES_REPORT'); ?></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
<form  method="post">                                
...
<div class="card-body">
<h4 align="center" style="color:blue"><?php echo sprintf(__('SALES_REPORT_FOR'), $fdate, $tdate); ?></h4>
<hr />
...
$gamount+=$tamount;
                                         $cnt=$cnt+1; } ?>
                                       <tr>
                                           <th colspan="2"><?php echo __('GRAND_TOTAL'); ?></th>
