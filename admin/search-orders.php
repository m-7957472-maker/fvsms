...
<html lang="ms">
    <head>
        ...
        <title><?php echo __('SITE_TITLE') . ' | ' . __('MANAGE_SEARCHED_ORDERS'); ?></title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo __('MANAGE_SEARCHED_ORDERS'); ?></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php"><?php echo __('DASHBOARD'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo __('MANAGE_SEARCHED_ORDERS'); ?></li>
                        </ol>
                        <div class="card mb-4">
...
?>
<h4 align="center" style="color:blue !important;"><?php echo sprintf(__('SEARCH_RESULT_FOR'), htmlentities($searchinput)); ?></h4>
<hr />
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php
$searchinput = isset($_POST['searchinputdata']) ? mysqli_real_escape_string($con, $_POST['searchinputdata']) : '';
...
$sql = "SELECT orders.id,orderNumber,totalAmount,orderStatus,orderDate,users.name,users.contactno 
    ...
    WHERE (users.name like '%" . $searchinput . "%' OR orders.orderNumber like '%" . $searchinput . "%') 
...
<span class="badge bg-secondary"><?php echo __('STATUS_IN_TRANSIT'); ?></span>
    <?php elseif($ostatus=='Out For Delivery'):?>
        ...
        <?php endif;?>
                                            ...
                                            <td>
                                            <a href="order-details.php?orderid=<?php echo $row['id']?>" target="_self" class="btn btn-primary btn-sm">
                                              <?php echo __('VIEW_DETAILS'); ?></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
