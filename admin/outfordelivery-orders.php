...
<html lang="ms">
    <head>
        ...
        <title>GHP INVENTORY MANAGEMENT SYSTEM | <?php echo __('MANAGE_OUT_FOR_DELIVERY'); ?></title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo __('MANAGE_OUT_FOR_DELIVERY'); ?></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php"><?php echo __('DASHBOARD'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo __('MANAGE_OUT_FOR_DELIVERY'); ?></li>
                        </ol>
                        <div class="card mb-4">
