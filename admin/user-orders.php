...
<html lang="ms">
    <head>
        ...
        <title><?php echo __('SITE_TITLE') . ' | ' . __('USER_ORDERS'); ?></title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo sprintf(__('MANAGE_USER_ORDERS'), htmlentities($username)); ?></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php"><?php echo __('DASHBOARD'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo sprintf(__('MANAGE_USER_ORDERS'), htmlentities($username)); ?></li>
                        </ol>
                        <div class="card mb-4">
...
$sql = "SELECT orders.id,orderNumber,totalAmount,orderStatus,orderDate,users.name,users.contactno 
    ...
    WHERE orders.userId='" . mysqli_real_escape_string(
        $con,
        $userid
    ) . "' 
...
<span class="badge bg-secondary"><?php echo __('STATUS_IN_TRANSIT'); ?></span>
    <?php elseif($ostatus=='Out For Delivery'):?>
        ...
        <?php endif;?>
                                        ...
                                        <?php $cnt=$cnt+1; } } else { ?>
                                   <tr>
                                       <th colspan="7" style="color:red;"><?php echo __('NO_ORDERS_YET'); ?></th>
                                   </tr>
                                        <?php } ?>
